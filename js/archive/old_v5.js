...
document.addEventListener("DOMContentLoaded", function() {
  ...
  function displayTree(root, maxDepth) {
        ...
        if (file) {
            ...
            reader.onload = function(event) {
                ...
                try {
                    ...
                    displayTree(currentRoot,maxDepth);
                } catch (error) {
    ...
    document.getElementById('updateDepthButton').addEventListener('click', function() {
        const maxDepth = parseInt(document.getElementById('depthInput').value, 10);
        console.log("New depth:",maxDepth);
        if (!isNaN(maxDepth)) {
            displayTree(currentRoot,maxDepth);
        }
    });
